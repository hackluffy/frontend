    ...
    toParkingPlace(parking: Parking) {
        ...
        return new this.ymaps.GeoObject({
            ...
            properties: {
                ...
                '<p class="balloon__curr__number" style="padding:6.5px 13px 6.5px 6.5px;">Количество текущих мест:' + parking.current_places + '</p>' +
                ...
                '<div class="balloon__payment">Способ оплаты:</div>' + '<img src="../../assets/images/pay4.png" style="width:30px; height:30px; padding:6.5px 13px 6.5px 6.5px; border:1px solid #FFD204;" alt=""/>' +
            '</div>'
